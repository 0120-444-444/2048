...
const game2 = new Game("gameboard2");
var score = 0;
var score2 = 0;
// key 入力
document.addEventListener("keydown", (e) => {
  ...
  if (global.keys[38]) { // up
    ...
    score = game2.move(3);
    WriteScore();
  } else if (global.keys[87]) {
    socre2 = game.move(0);
    WriteScore2();
  } else if (global.keys[68]) {
    score2 = game.move(1);
    WriteScore2();
  } else if (global.keys[83]) {
    score2 = game.move(2);
    WriteScore2();
  } else if (global.keys[65]) {
    score2 = game.move(3);
    WriteScore2();
  }
});
...
function WriteScore2(){
  ...
  document.getElementById("syurasuko").textContent = String(score2);
}
function WriteScore(){
  localStorage.setItem("score",score);
  document.getElementById("syurasuko2").textContent = String(score);
}
WriteScore();
WriteScore2();
